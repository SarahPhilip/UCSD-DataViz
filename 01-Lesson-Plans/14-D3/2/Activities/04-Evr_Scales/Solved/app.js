...
console.log(`The height of Sarah's bar: ${yScale(testScores[1])}`)
console.log(`The height of Matt's bar: ${yScale(testScores[2])}`)
console.log(`The height of Ruchi's bar: ${yScale(testScores[3])}`)
